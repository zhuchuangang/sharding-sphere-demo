...
public interface UserDAO {
     ...
     * @return UserDO
     */
    @Select("select user_id as userId,username,password from t_user where user_id between #{max} and #{min}")
    List<UserDO> findBetween(@Param("max") Long max, @Param("min") Long min);
}
